...
INSERT INTO "new_Record" ("binNo", "chassisNo", "completedAt", "createdAt", "dronaSupervisor", "electrician", "fitter", "helper", "id", "inTime", "modelNo", "outTime", "painter", "productionInchargeFromVBCL", "remarks", "shift", "srNoVehicleCount", "status", "type", "updatedAt") SELECT "binNo", "chassisNo", "completedAt", "createdAt", "dronaSupervisor", "electrician", "fitter", "helper", "id", "inTime", "modelNo", "outTime", "painter", "productionInchargeFromVBCL", "remarks", "shift", "srNoVehicleCount", "status", "type", "updatedAt" FROM "Record";
DROP TABLE "Record";
